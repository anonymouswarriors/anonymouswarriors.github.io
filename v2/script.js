...
const COMMANDS = {
    ...
    ls: 'Supported commands: <span class="code">notes</span>, <span class="code">hacking video</span>, <span class="code">pdf course</span><span class="code">links</span>',
    ...
    about: "Hello 👋<br>I'm 𝕿𝖍𝖊 𝕻𝖍𝖆𝖓𝖙𝖔𝖒 ✘. Information Security enthusiast, I do bug bounty hunting, Capture The Flag as a hobby and passion, Grapic Design, 2D Animation,...",
...
inputfield.addEventListener('keypress', (e) => {
    if (e.key === "Enter") {
        ...
        let output;
        output = `<div class="terminal-line"><span class="code1">>_</span> <span class="success">$root</span><span class="directory">@𝕻𝖍𝖆𝖓𝖙𝖔𝖒:~$</span> ${input}</div>`;
...
function showTerminal() {
    document.getElementById('hero').classList.toggle('active');
}
function showTerminal(){
    if(hero==1){
